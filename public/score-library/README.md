...
- 100 MusicXML files: 12 MuseTrainer, 18 OpenScore Lieder, 58 PDMX, and 12 reproducibly generated Melodica Trainer CC0 transcriptions.
- 12 Guitar Pro 7 files: six melodies converted from reviewed PDMX MusicXML and six original CC0 exercises.
- 89 of the 100 MusicXML entries are tagged `beginner` or `familiar`.
...
The 12 Melodica Trainer transcriptions are generated from the reviewed metadata and note data in `scripts/library-selections/cc0-melodies.json`. The generator writes deterministic one-part, one-staff MXL files and assigns the resulting transcriptions to CC0.
